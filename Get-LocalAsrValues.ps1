...
.NOTES
    ...
    Version 2.0 - 2025-06-17
     ...
     Version 2.1 - 2025-06-17
            - Modified name to meet naming conventions
            - Added piaudonn to authors
            - Added additional telemetry sources from OS and Defender
#>
...
Write-Output "OSName: $((Get-ComputerInfo).OSName)" | Tee-Object -FilePath $outputFilePath -Append
Write-Output "OSVersion: $((Get-ComputerInfo).OSVersion)" | Tee-Object -FilePath $outputFilePath -Append
Write-Output "AMEngineVersion: $((Get-MpComputerStatus).AMEngineVersion)" | Tee-Object -FilePath $outputFilePath -Append
Write-Output "AMProductVersion: $((Get-MpComputerStatus).AMProductVersion)" | Tee-Object -FilePath $outputFilePath -Append
Write-Output "AntiSpywareSignatureVersion: $((Get-MpComputerStatus).AntiSpywareSignatureVersion)" | Tee-Object -FilePath $outputFilePath -Append
Write-Output "AntivirusSignatureVersion: $((Get-MpComputerStatus).AntivirusSignatureVersion)`n" | Tee-Object -FilePath $outputFilePath -Append 
